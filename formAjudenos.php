...
<table cellspacing="5">
		...
		<tr>
			...
			<td><input type="text" class="nome" name="nomePessoa" placeholder="Nome"></td>
			
			<td><input type="text" class="sobrenomeEmail" name="sobrenomePessoa" placeholder="Sobrenome"></td>
		</tr>
		
		<tr>
			<td><input type="text" class="tel"  name="telPessoa" placeholder="Telefone (xx) XXXX-XXXX"></td>
			
			<td><input type="text" class="sobrenomeEmail" name="emailPessoa" placeholder="E-mail"></td>
		</tr>
	...
	<td><input type="text" class="quantidade" name="qtde" placeholder="Quantidade"></td>
...
?>
			...
			<tr>
				<td><textarea rows="3" cols="22" name="descricao" class="desc" placeholder="Descrição"></textarea></td>	
			</tr>
