...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <!--Java Script -->
  <script type="text/javascript" src="js/alertValidacoes.js"></script>
  <!--Bootstrap-->
    ...
    <ul class="nav navbar-nav">
	  ...
	  <a class="dropdown-toggle" data-toggle="dropdown" href="#">Adotar Animal<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="adotaDogs.php">Cachorro</a></li>
          <li><a href="adotaCat.php">Gato</a></li>
        </ul>
      </li>
	  
	  <li > <a href="#" onclick="funcaoAlert()">Doar Animal</a> </li><!--FAZER UM ALERT PARA QUE O USUÁRIO FAÇA LOGIN ANTES DE DOAR UM ANIMAL -->
	  ...
	  <li><a href="#about">Sobre</a></li><!--Rolar a tela para o contato -->
