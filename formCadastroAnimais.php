...
<br>
	...
	<form action="cadastraAnimais.php" method="POST">
		...
		<tr>
			...
			<td><input type="text" class="inputEsquerdaNomeAnimal"  name="nomeAnimal" placeholder="Digite o nome do animal"></td>
			
			<td><input type="number" class="inputDireitaIdadeAnimal" id="idade" name="idadeAnimal" placeholder="Idade do animal">
...
<!--Aqui vai o telefone e email do usuário que já está logado no site, por meio de um select-->			
		...
		<textarea rows="3" cols="22" name="observacaoAnimal" class="areaTexto" placeholder="Digite informações adicionais sobre o animal"></textarea>
